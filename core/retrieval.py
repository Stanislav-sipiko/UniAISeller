...
class RetrievalEngine:
    ...
    def _semantic_rerank(
        ...
        valid_categories = [cat_lower]
        if cat_lower in cat_map:
            valid_categories.extend([c.lower() for c in cat_map[cat_lower]])
        ...
        for p in products:
            ...
            cat_bonus = 0.3 if any(vc == p_cat or vc in p_cat for vc in valid_categories) else 0.0
